...
import huawei.com.sign.SignUtils;
...
public class AliPay {
    ...
    public static class Builder{
         ...
         * 设置商户PID
         */
        private String PARTNER = "2017072007818783";
        //商户收款账号
        private String SELLER = "13714624524";
        //商户私钥，pkcs8格式
        private String RSA_PRIVATE = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA2cFK1TyS6GdD/jhrEJclxq" +
                "LxMwnfGZvBZgYXyD8ityHK6fQfBycI5a9Zcao2k5MCvCtAawKvHI7TCn/Y6fUNsPYnDNZ4kuABfw/TgI1j7rnoC" +
                "26Myl6VZYK+RbUTqbTVHgfBveC50/Wg2tUuton8juQZok7LWV8aflPovjwiB9LlxhvkgQOXMr69cPJT1qbo5SeN" +
                "s+mjg8w4TwiqApiw5+ncSE1vip4uL5TmeRkD3EosE/p+tBkotFDRl4NpfbkvN34yFhGI5/+8lxwFnCbby4bN/uh" +
                "/zYIHKVMsFTdctMCnbCWYGce2Va7IEomgVARUqRdOya2qyB9onaoZLnbuPQIDAQAB";
        //支付公钥，pkcs8格式
        ...
        public void pay(){
            ...
            /**
             * 特别注意，这里的签名逻辑要放在服务端，切记将私钥放泄露在代码中！
             */
